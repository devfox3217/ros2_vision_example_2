...
class GUINode(Node):
    def __init__(self):
        ...
        # Subscribers
        self.sub_camera = self.create_subscription(Image, '/camera_open', self.camera_callback, qos_profile)
        self.sub_debug = self.create_subscription(Image, '/lane_debug_img', self.debug_callback, qos_profile)
        self.sub_visual = self.create_subscription(Image, '/lane_visual', self.visual_callback, qos_profile)
